...
A MelonLoader mod for **Schedule I** that gives players visibility and control over client assignments.
...
- Automatically flag dealer-assigned clients whose weekly spend exceeds a threshold
- Label these as "Should Be Player" or similar
